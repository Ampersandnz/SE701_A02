...
public final class SourceToSourceVisitor implements VoidVisitor<Object> {
	...
	public void visit(OpenStmt n, Object arg) {
		...
		if (n.getIsFile()) {
			...
			Symbol resolvedSymbol = currentScope.resolve(n.getTarget());

			if (resolvedSymbol == null) {
				throw new A2SemanticsException("Stream variable " + n.getTarget() + " does not exist within this scope! (On line " + n.getBeginLine() + ").");
			}

			if (resolvedSymbol instanceof VariableSymbol) {
			} else {
				throw new A2SemanticsException("Resolved symbol "
						+ n.getTarget() + " is not a variable! (is a "
