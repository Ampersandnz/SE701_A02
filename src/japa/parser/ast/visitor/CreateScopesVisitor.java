...
public class CreateScopesVisitor implements VoidVisitor<Object> {
	...
	public void visit(CompilationUnit n, Object arg) {
		...
		globalScope.setEnclosingScope(globalScope);
	...
	public void visit(ClassOrInterfaceDeclaration n, Object arg) {
		...
		if (n.isInterface()) {
			// Not a scope, interfaces only declare method signatures not
			// variables.
		} else {
			...
			System.out.println("Created class scope " + n.getName());
	...
	public void visit(BlockStmt n, Object arg) {
		...
		n.setEnclosingScope(localScope);
